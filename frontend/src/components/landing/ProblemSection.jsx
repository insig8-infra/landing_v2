...
export const ProblemSection = () => {
  ...
  return (
    <section className="relative py-24 sm:py-32 overflow-hidden" data-testid="problem-section" id="problem">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        >
          <span className="text-eyebrow text-amber-400 mb-4 block" data-testid="problem-eyebrow">{eyebrow}</span>
          <h2 className="text-display-section mb-4" data-testid="problem-headline">{headline}</h2>
          <p className="text-body-lg text-support max-w-xl mx-auto" data-testid="problem-subheadline">{subheadline}</p>
        </motion.div>
        ...
        >
          {cards.map((card, i) => (
            ...
            >
              ...
              <p className="text-body-sm text-support mb-5 leading-relaxed">{card.body}</p>
